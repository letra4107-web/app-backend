...
const stateMeta = {
  ...
  unlocked: { label: 'Handa na', icon: 'play' as const, color: colors.lavenderDark, bg: '#E5F1EF' },
...
const styles = StyleSheet.create({
  ...
  assessmentEyebrow: { color: '#E5F1EF', fontSize: 11, fontWeight: '900', letterSpacing: 1.2 },
  detailTitle: { color: '#fff', fontSize: typography.size.hero, fontFamily: typography.family.display, marginTop: 4 },
  detailSubtitle: { color: '#E5F1EF', fontSize: 14, lineHeight: 20, marginTop: 5 },
  ...
  scopeNote: { flexDirection: 'row', gap: 9, backgroundColor: '#E5F1EF', padding: 13, borderRadius: radius.sm, marginBottom: 20 },
  ...
  levelPill: {
    ...
    backgroundColor: '#E5F1EF', borderRadius: radius.pill, paddingHorizontal: 13, paddingVertical: 7, marginBottom: 16,
  },
  ...
  moduleImageWrap: { width: 62, height: 62, borderRadius: radius.md, backgroundColor: '#E5F1EF', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' },
  ...
  progressTrack: { height: 7, borderRadius: 4, backgroundColor: '#DDDCD5', overflow: 'hidden', marginTop: 11 },
  ...
  soundButton: { position: 'absolute', top: 8, right: 8, width: 32, height: 32, borderRadius: 16, backgroundColor: '#E5F1EF', alignItems: 'center', justifyContent: 'center' },
  ...
  practiceButton: { borderRadius: radius.pill, backgroundColor: '#E5F1EF', paddingHorizontal: 12, paddingVertical: 6, marginTop: 9 },
  ...
  questionProgress: { height: 8, borderRadius: 4, backgroundColor: '#DDDCD5', overflow: 'hidden', marginBottom: 24 },
  ...
  choiceCard: { width: '48%', minHeight: 82, borderRadius: radius.md, backgroundColor: '#fff', alignItems: 'center', justifyContent: 'center', padding: 10, borderWidth: 2, borderColor: '#DDDCD5', ...shadows.card },
  ...
  resultSubtitle: { color: '#E5F1EF', textAlign: 'center', lineHeight: 20 },
